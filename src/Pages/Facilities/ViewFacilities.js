...
function ViewFacilities() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/getFacility`);
    ...
    const handleDelete = async (facilitiesId) => {
        try {
            await axios.post(`${process.env.REACT_APP_MONGO_BASE_URL}/deleteFacility`, {
                facilitiesId,
            });
    ...
    const confirmDelete = (facilitiesId) => {
            ...
            <div>
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        handleDelete(facilitiesId); // Handle delete operation
                    }}
                >
                    Confirm
                </button>
        ...
        <>
            ...
            <main role="main" className="main-content">
                <div className="container-fluid">
                    <Link to={"/addFacilities"} className="btn btn-primary">
                        Add Facility
                    </Link>
                                    ...
                                    <div className="card shadow mb-4">
                                        <div className="card-body">
                                            <div className="chart-widget mb-4">
                                                <img
                                                    src={`${process.env.REACT_APP_MONGO_BASE_URL}/images/facilityPics/${dataItem.facilityPics[0]}`}
                                                    className="img-fluid"
                                                    style={{ height: "200px", objectFit: "cover" }}
                                                    alt="event"
                                                />
                                            </div>
                                            <h5 className="card-title">{dataItem.facilityName}</h5>
                                            <div className=" text-center">
                                                <button
                                                    type="button"
